...
namespace SkeletorDAL
{
    public class HorseContextInitializer : DropCreateDatabaseAlways<HorseContext>
    {
        ...
        public HorseContextInitializer()
        {
            ...
            var Helge = new Horse("Helge", DateTime.Now, "Camargue", 150, "1a i VM 2005", "650.000", ("https://www.facebook.com/cramagoTriton?__mref=message_bubble")) { Rent = true, Gender = "Male", ImagePath = @"~/ProfileImages/1Dummy1.jpg", Description = "Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla", Medicine = "Detta är Helges Medicin", FamilyTree = "Detta är Helges släktträd" };
            var Jens = new Horse("Jens", DateTime.Now, "Ponny", 44, string.Empty, "350.000", ("https://www.facebook.com/cramagoTriton?__mref=message_bubble")) { Gender = "Male", ImagePath = "~/ProfileImages/2Dummy2.gif", Description = "Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla", Medicine = "Detta är Jens Medicin", FamilyTree = "Detta är Jens släktträd" };
            var Gösta = new Horse("Gösta", DateTime.Now, "Camargue", 100, "-", "100.000", ("https://www.facebook.com/cramagoTriton?__mref=message_bubble")) { Breeding = true, Gender = "Male", ImagePath = "~/ProfileImages/3Dummy3.jpg", Description = "Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla", Medicine = "Detta är Gösta Medicin", FamilyTree = "Detta är Gösta släktträd" };
            var Adolf = new Horse("Adolf", DateTime.Now, "Ponny", 150, "Superduktig men har inte vunnit något", "1 000 000", ("https://www.facebook.com/cramagoTriton?__mref=message_bubble")) { Gender = "Male", ImagePath = "~/ProfileImages/DefaultHead.jpg", Description = "Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla", Medicine = "Detta är Adolf beskrivning", FamilyTree = "Detta är Adolf släktträd" };
            var Hermina = new Horse("Hermina", DateTime.Now, "Camargue", 150, "Superduktig men har inte vunnit något", "1 000 000", ("https://www.facebook.com/cramagoTriton?__mref=message_bubble")) { IsSold = true, Gender = "Female", ImagePath = "~/ProfileImages/DefaultHead.jpg", Description = "Detta är Herminas Medicin", Medicine = "Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla", FamilyTree = "Detta är Herminas släktträd" };
            var LillBritt = new Horse("LillBritt", DateTime.Now, "Vanlig Häst", 150, "Superduktig men har inte vunnit något", "1 000 000", ("https://www.facebook.com/cramagoTriton?__mref=message_bubble")) { Rent = true, Gender = "Female", ImagePath = "~/ProfileImages/DefaultHead.jpg", Description = "Detta är LillBritt Medicin", Medicine = "Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla", FamilyTree = "Detta är LillBritts släktträd" };
            var Lisa = new Horse("Lisa", DateTime.Now, "Camargue", 150, "Superduktig men har inte vunnit något", "1 000 000", ("https://www.facebook.com/cramagoTriton?__mref=message_bubble")) { Gender = "Female", ImagePath = "~/ProfileImages/DefaultHead.jpg", Description = "Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla \n \n Här kan du skriva precis vad du vill om hästen \n Precis vad du vill \n Allt ska funka, även med radbryt som du ser \n bla bla bla", Medicine = "Detta är Lisa beskrivning", FamilyTree = "Detta är Lisas släktträd" };
            ...
            var HerminaBlog = new Blog("Detta är Hermina Blogg", DateTime.Now, new List<Post>()
			{
				new Post("Hermina första inlägg", DateTime.Now, "Hjehhej"),
				new Post("Hermina andra inlägg", DateTime.Now, "ghahhaha")
			});
            Hermina.Blog = HerminaBlog;
            var LillBrittBlog = new Blog("Detta är LillBritt Blogg", DateTime.Now, new List<Post>()
			{
				new Post("LillBritt första inlägg", DateTime.Now, "Hjehhej"),
				new Post("LillBritt andra inlägg", DateTime.Now, "ghahhaha")
			});
            LillBritt.Blog = LillBrittBlog;
            var LisaBlog = new Blog("Detta är Lisa Blogg", DateTime.Now, new List<Post>()
			{
				new Post("Lisa första inlägg", DateTime.Now, "Hjehhej"),
				new Post("Lisa andra inlägg", DateTime.Now, "ghahhaha")
			});
            Lisa.Blog = LisaBlog;
            ...
            blogs = new List<Blog>()
			{
				HelgeBlog, JensBlog, GöstaBlog, AdolfBlog, HerminaBlog, LillBrittBlog, LisaBlog
			};
            users = new List<User>()
			{
